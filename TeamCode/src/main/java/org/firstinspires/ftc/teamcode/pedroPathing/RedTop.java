...
public class RedTop extends OpMode {
    ...
    private final Pose pickup1Pose = new Pose(126.6, 85.029, Math.toRadians(0)); // Highest (First Set) of Artifacts from the Spike Mark.
    private final Pose control1=new Pose(75.535,57.191);
    private final Pose control2=new Pose(68.315,31.519);
    private final Pose pickup2Pose = new Pose(128.6, 62.561, Math.toRadians(0)); // Middle (Second Set) of Artifacts from the Spike Mark.
    private final Pose pickup3Pose = new Pose(128.6, 35.304, Math.toRadians(0)); // Lowest (Third Set) of Artifacts from the Spike Mark.
