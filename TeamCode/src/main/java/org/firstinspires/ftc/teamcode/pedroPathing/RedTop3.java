...
public class RedTop3 extends OpMode {
    ...
    private final Pose pickup2Pose = new Pose(129.6, 60.561, Math.toRadians(0)); // Middle (Second Set) of Artifacts from the Spike Mark. NOT FIXED POSE 2 WITH VIZ NORM = 129.6 60.561
