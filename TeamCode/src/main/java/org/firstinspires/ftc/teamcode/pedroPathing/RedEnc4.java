...
public class RedEnc4 extends OpMode {
    ...
    private final Pose startPose = new Pose(138.752, 134.752, Math.toRadians(270));
    ...
    private final Pose pickup2Pose = new Pose(155, 71.7, Math.toRadians(0));
