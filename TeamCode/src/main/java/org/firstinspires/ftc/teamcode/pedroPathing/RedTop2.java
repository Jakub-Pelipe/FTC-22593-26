...
public class RedTop2 extends OpMode {
    ...
    private final Pose pickup2Pose = new Pose(129.6, 59.761, Math.toRadians(180)); // Middle (Second Set) of Artifacts from the Spike Mark.  FIXED POSE 2 WITH VIZ NORM = 129.6 60.561
